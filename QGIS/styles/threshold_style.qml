...
<qgis maxScale="0" minScale="1e+08" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" version="3.4.15-Madeira">
  <flags>
  ...
  <pipe>
    <rasterrenderer type="singlebandpseudocolor" alphaBand="-1" classificationMax="1" band="1" classificationMin="0" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="EXACT" clip="0" classificationMode="1">
          ...
          <item value="0" color="#ff00ff" alpha="0" label="0"/>
          <item value="1" color="#003b60" alpha="255" label="1"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
    <brightnesscontrast contrast="0" brightness="0"/>
    <huesaturation colorizeGreen="128" colorizeRed="255" colorizeOn="0" colorizeBlue="128" grayscaleMode="0" colorizeStrength="100" saturation="0"/>
