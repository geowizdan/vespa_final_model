...
# Define input paths
# -------------------------------
bioclim_path <- "data/rasters/bioclim/projected_region/unclipped_bioclim_8_rasters/ssp245_8_bioclim_rast.tif"

urban_path  <- "data/rasters/aggregation_LULC/projection_region/LU1-BAU/LU1_urban_agg_10km.tif"
forest_path <- "data/rasters/aggregation_LULC/projection_region/LU1-BAU/LU1_forest_agg_10km.tif"
agri_path   <- "data/rasters/aggregation_LULC/projection_region/LU1-BAU/LU1_agriculture_agg_10km.tif"

output_path <- "data/rasters/projection_stack/245_LU1/predictor_stack_rcp245_lu1.tif"
